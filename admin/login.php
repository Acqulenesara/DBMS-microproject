  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      <div class="row justify-content-center">
          <div class="col-lg-6">
              <h1 class="mt-4 mb-3" style="color:#ff0000 ;">
      ...
      <div class="card" style="height: 250px; background-image: url('admin_image/glossy1.jpg'); background-size: cover; background-position: center; border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); overflow: hidden;">
  <div class="card-body" style="background: rgba(255, 255, 255, 0.6); padding: 20px; border-radius: 15px;">
