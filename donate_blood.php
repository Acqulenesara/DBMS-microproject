...
<head>
  ...
  <script type="text/javascript">
    ...
    function validateForm() {
      var age = document.forms["donor"]["age"].value;
      if (age < 18) {
        alert("Donors must be 18 years or older.");
        return false; // Prevent form submission
      }
      return true; // Proceed if age is valid
    }
  </script>
</head>
  ...
  <div id="page-container" style="margin-top:50px; position: relative;min-height: 84vh;">
    <div class="container">
      <div id="content-wrap" style="padding-bottom:50px;">
        ...
        <!-- Added onsubmit attribute to call JavaScript function validateForm -->
